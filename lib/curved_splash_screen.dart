  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: CurvedSheet(
        ...
        currentPage: currentPageIndex,
        firstGradiantColor:
            widget.firstGradiantColor ?? const Color(0xff62cbe5),
        secondGradiantColor: widget.secondGradiantColor ??
            Colors.lightBlueAccent.withOpacity(0.9),
        backText: widget.backText ?? "Back",
        skipText: widget.skipText ?? "Skip",
        forwardColor: widget.forwardColor ?? Colors.red,
        forwardIconColor: widget.forwardIconColor ?? Colors.white,
        textColor: widget.textColor ?? Colors.white.withOpacity(0.85),
        backgroundColor: widget.backgroundColor ?? Colors.white,
        bottomSheetColor: widget.bottomSheetColor ??
            widget.firstGradiantColor ??
            const Color(0xff62cbe5),
        skip: () {
          widget.onSkipButton();
        },
        back: () {
